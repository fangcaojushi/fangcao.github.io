...
var AdDivW = 100;		//宽度
var AdDivH = 300;		//高度
var PageWidth = 980;	//页面多少宽度象素下正好不出现左右滚动条
...
var AdContentHtml = '<div align="center" style="color:green;font-size:23pt;font-family:黑体;"> <a href="heci.html" target="_blank"><img src="images/hc.gif" width="100" height="300" border="0"></a></div>';
...
window.onload=scall;// JavaScript Document