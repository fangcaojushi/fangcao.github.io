...
//		    	show : false,
                ...
                x: 'center',
                y: 18,
		        data : ['华通智能交通公司','鸿信系统集成公司','无锡天舜科技公司','元欣高英科技公司','正元信息科技公司'],
		    },
		    calculable : true,
		    series : [
		        {
		            ...
		            data:[
		                {value:160, name:'华通智能交通公司'},
		                {value:140, name:'鸿信系统集成公司'},
		                {value:120, name:'无锡天舜科技公司'},
		                {value:180, name:'元欣高英科技公司'},
		                {value:100, name:'正元信息科技公司'}
		            ]
		        }
		    ]
		};                    
