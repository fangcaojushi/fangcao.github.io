...
//<!--*********************设置目录树高度以及右侧视频插件的宽度************************-->
    $(function(){
        ...
        $(".tree_left").css("height",(winHeight-247-hone)+"px");
        var top = $(".tree_top").height();
        $(".shoushuo_window").css("height",(winHeight-247-hone-top)+"px");
        $(".right_z").css("width",(winWidth-260)+"px");
        $(".right_z").css("height",(winHeight)+"px");
