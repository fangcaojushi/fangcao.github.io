...
/***********************抽屉*******************************************/		
	...
	$('.win_title1').click(function(){
    var shoushuo_window1=$(this).parent();
		if(shoushuo_window1.hasClass('shoushuo_window1_hidden'))
		{
			shoushuo_window1.removeClass('shoushuo_window1_hidden');
		}
		else
		{
			shoushuo_window1.addClass('shoushuo_window1_hidden');
		}
	  });
...
//<!--input获得焦点时图标替换-->
	$(function(){
		$(".treehight .search_left .text").focus(function(){
   		 var p1 = $(".search_left").find("img").attr('src','images/sou1.png');
	})
		
		$(".search_left .text").blur(function(){
   		 var p1 = $(".search_left").find("img").attr('src','images/sou.png');
	})
});